...
namespace Equinor.ProCoSys.IPO.Domain.AggregateModels.InvitationAggregate
{
    public interface IInvitationRepository : IRepository<Invitation>
    {
        ...
        bool IsExistingProject(Guid toProjectGuid);
        bool IsExistingCommPkg(Guid commPkgGuid);
        void MoveCommPkg(Guid toProjectGuid, Guid commPkgGuid);
        void UpdateCommPkgDescriptionOnInvitations(Guid commPkgGuid, string description);
