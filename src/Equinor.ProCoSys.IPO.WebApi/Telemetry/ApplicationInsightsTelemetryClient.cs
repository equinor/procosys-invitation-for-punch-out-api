...
namespace Equinor.ProCoSys.IPO.WebApi.Telemetry
{
    public class ApplicationInsightsTelemetryClient : ITelemetryClient
    {
        ...
        public void TrackMetric(string name, double metric, string dimension1Name, string dimension1Value)
            => _ai.GetMetric(name, dimension1Name).TrackValue(metric, dimension1Value);
        ...
        public void TrackMetric(
            ...
            => _ai.GetMetric(name, dimension1Name, dimension2Name).TrackValue(metric, dimension1Value, dimension2Value);
    }
}
