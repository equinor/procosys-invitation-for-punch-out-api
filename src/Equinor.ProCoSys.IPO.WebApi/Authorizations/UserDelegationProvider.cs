...
public class UserDelegationProvider : IQueryUserDelegationProvider
{
    private readonly BlobServiceClient _blobServiceClient;
    private UserDelegationKey _userDelegationKeyCached;
    private DateTimeOffset? _expirationTime;

    public UserDelegationProvider(IOptionsMonitor<BlobStorageOptions> options, ITokenCredential credential)
    {
