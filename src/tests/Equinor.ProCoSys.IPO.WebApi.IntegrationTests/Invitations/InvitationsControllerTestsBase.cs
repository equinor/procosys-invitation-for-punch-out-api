...
namespace Equinor.ProCoSys.IPO.WebApi.IntegrationTests.Invitations
{
    public class InvitationsControllerTestsBase : TestBase
    {
        ...
        protected readonly int InitialMdpInvitationId = TestFactory.Instance.KnownTestData.InvitationIds.First();
        protected readonly int InitialDpInvitationId = TestFactory.Instance.KnownTestData.InvitationIds.Last();
