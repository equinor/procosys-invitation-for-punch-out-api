...
namespace Equinor.ProCoSys.IPO.Command.Tests.InvitationCommands.UpdateRfocAccepted
{
    ...
    public class UpdateRfocAcceptedCommandHandlerTests
    {
        ...
        private Mock<ICommPkgApiForApplicationService> _commPkgApiServiceMock;
        ...
        public void Setup()
        {
            ...
            _commPkgApiServiceMock = new Mock<ICommPkgApiForApplicationService>();
            ...
            _invitation = new Invitation(
                    ...
                    new DateTime(),
                    null,
                    new List<McPkg> { new McPkg(_plant, _project, "CommNo1", "McNo1", "d", "1|2", Guid.Empty, Guid.Empty), new McPkg(_plant, _project, "CommNo1", "McNo2", "d", "1|2", Guid.Empty, Guid.Empty) },
                    null);
        ...
        public async Task HandlingUpdateRfocStatusCommand_ShouldCreateCertificateAndCreateRelation()
        {
            var mcPkgs = new List<McPkg> {
                new McPkg(_plant, _project, _commPkgNo, _mcPkgNo, "description", "1|2", Guid.Empty, Guid.Empty),
                new McPkg(_plant, _project, _commPkgNo, _mcPkgNo2, "description", "1|2", Guid.Empty, Guid.Empty),
                new McPkg(_plant, _project, _commPkgNo, _mcPkgNo3, "description", "1|2", Guid.Empty, Guid.Empty)
            };
