...
namespace Equinor.ProCoSys.IPO.Command.Tests.InvitationCommands.CancelPunchOut
{
    ...
    public class CancelPunchOutCommandValidatorTests
    {
        ...
        public void Setup_OkState()
        {
            ...
            _invitationValidatorMock.Setup(inv => inv.CurrentUserIsAdminOrCreatorOrCompletorAsync(_id, default)).Returns(Task.FromResult(true));
        ...
        {
            _invitationValidatorMock.Setup(inv => inv.CurrentUserIsAdminOrCreatorOrCompletorAsync(_id, default)).Returns(Task.FromResult(false));
