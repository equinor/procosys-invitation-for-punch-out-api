...
namespace Equinor.ProCoSys.IPO.Command.Tests.EventHandlers
{
    ...
    public class EventDispatcherTests
    {
        ...
        [TestMethod]
        public async Task DispatchPostSaveEventsAsync_SendsOutEvents_Test()
        {
            var mediator = new Mock<IMediator>();
            var dut = new EventDispatcher(mediator.Object);
            var entities = new List<TestableEntityBase>();
        ...
        [TestMethod]
        public async Task DispatchDomainEventsAsync_ThrowsException_IfListIsEmptyAsync_Test()
        {
            var mediator = new Mock<IMediator>();
            var dut = new EventDispatcher(mediator.Object);
        ...
        [TestMethod]
        public async Task DispatchPostSaveEventsAsync_ThrowsException_IfListIsEmptyAsync_Test()
        {
            var mediator = new Mock<IMediator>();
            var dut = new EventDispatcher(mediator.Object);
