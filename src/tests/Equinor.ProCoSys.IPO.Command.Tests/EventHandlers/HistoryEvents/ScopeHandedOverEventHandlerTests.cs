...
{
    [TestClass]
    public class ScopeHandedOverEventHandlerTests
    {
        private Mock<IHistoryRepository> _historyRepositoryMock;
        private ScopeHandedOverEventHandler _dut;
        ...
        public void Setup()
        {
            ...
            _dut = new ScopeHandedOverEventHandler(_historyRepositoryMock.Object);
        }

        [TestMethod]
        public void Handle_ShouldAddscopeHandedOverHistoryRecord()
        {
            // Arrange
            ...
            var plant = "TestPlant";
            _dut.Handle(new ScopeHandedOverEvent(plant, sourceGuid, null), default);
            ...
            Assert.AreEqual(EventType.ScopeHandedOver, _historyAdded.EventType);
