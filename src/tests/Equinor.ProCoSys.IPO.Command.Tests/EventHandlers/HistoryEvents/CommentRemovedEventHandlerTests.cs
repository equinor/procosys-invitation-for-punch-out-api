...
{
    [TestClass]
    public class CommentRemovedEventHandlerTests
    {
        private Mock<IHistoryRepository> _historyRepositoryMock;
        private CommentRemovedEventHandler _dut;
        ...
        public void Setup()
        {
            ...
            _dut = new CommentRemovedEventHandler(_historyRepositoryMock.Object);
        }

        [TestMethod]
        public void Handle_ShouldAddCommentRemovedHistoryRecord()
        {
            // Arrange
            ...
            var plant = "TestPlant";
            _dut.Handle(new CommentRemovedEvent(plant, sourceGuid, Guid.Empty), default);
            ...
            Assert.AreEqual(EventType.CommentRemoved, _historyAdded.EventType);
