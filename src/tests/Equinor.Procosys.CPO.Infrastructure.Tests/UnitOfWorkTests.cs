...
using Equinor.Procosys.CPO.Test.Common;
...
namespace Equinor.Procosys.CPO.Infrastructure.Tests
{
    ...
    public class UnitOfWorkTests
    {
        ...
        private DbContextOptions<CPOContext> _dbContextOptions;
        ...
        {
            using var dut = new CPOContext(_dbContextOptions, _plantProviderMock.Object, _eventDispatcherMock.Object, _currentUserProviderMock.Object);
