...
using Equinor.Procosys.CPO.Domain.Exceptions;
using Microsoft.EntityFrameworkCore;

namespace Equinor.Procosys.CPO.Infrastructure
{
    public class CPOContext : DbContext, IUnitOfWork, IReadOnlyContext
    {
        ...
        public CPOContext(
            DbContextOptions<CPOContext> options,
        ...
        private void SetGlobalPlantFilter(ModelBuilder modelBuilder)
        {
            ...
            {
                typeof(CPOContext)
                .GetMethod(nameof(CPOContext.SetGlobalQueryFilter))
